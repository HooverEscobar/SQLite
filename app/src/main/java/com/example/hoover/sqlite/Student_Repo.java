...
class StudentRepo {
    ...
    public int insert(Student student) {
        ...
        values.put(Student.KEY_direccion, student.direccion);
        values.put(Student.KEY_email,student.email);
        values.put(Student.KEY_name, student.name);
        values.put(Student.KEY_apellido, student.apellido);
    ...
    public ArrayList<HashMap<String, String>>  getStudentList() {
        ...
        String selectQuery =  "SELECT  " +
                Student.KEY_ID + "," +
                Student.KEY_name + "," +
                Student.KEY_apellido + "," +
                Student.KEY_email + "," +
                Student.KEY_direccion +
                " FROM " + Student.TABLE;
    ...
    public Student getStudentById(int Id){
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                student.apellido =cursor.getString(cursor.getColumnIndex(Student.KEY_apellido));
                student.email  =cursor.getString(cursor.getColumnIndex(Student.KEY_email));
                student.direccion =cursor.getString(cursor.getColumnIndex(Student.KEY_direccion));
